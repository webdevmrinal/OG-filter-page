...
import { Card, Box, Typography, Divider, Avatar, Chip, Tabs, Tab, Skeleton } from "@mui/material";
  ...
  return (
    <Box sx={{ backgroundColor: "#f4f4f4", minHeight: "100vh", padding: 2 }}>
      <Box
        ...
        sx={{ height: "100%" }}
      >
        <GradientBox sx={{ marginBottom:5, padding: { xs: "auto", sm: "24px" }, }}>
          <GradientContent>
            {loading ? (
          ...
          transactions.map((transaction, index) => (
            <Card
              ...
              sx={{
                ...
                marginY: 1,
                paddingLeft: 1,
                borderLeft: `10px solid ${transaction.isPositive ? "#a5d6a7" : "#ef9a9a"}`,
                mx: 3,
                mt: 3,
                borderRadius: 2,
            ...
            >
              {loading ? (
                <>
                  <Skeleton variant="rectangular" width={90} height={95} sx={{ mb: 1, ml: 1.5 }} />
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", mr: 2 }}>
                    <Skeleton variant="circular" width={60} height={60} sx={{ ml: 1 }} />
                    <Skeleton variant="circular" width={60} height={60} sx={{ ml: -1 }} />
                  </Box>
                </>
              ) : (
                <>
                  ...
                  >
                    <Typography
                      variant="caption"
                      sx={{ alignSelf: "center", color: "text.secondary", mt: 1, ml: 0.5 }}
                    >
                      Booked on
                    </Typography>
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", mr: 2 }}>
                    <Avatar
                      ...
                      sx={{ width: { xs: 40, sm: 60 }, height: { xs: 40, sm: 60 }, zIndex: 2, ml: { xs: 0, sm: -1 } }}
                    />
                    <Avatar
                      src="https://example.com/avatar2.jpg"
                      sx={{ width: { xs: 40, sm: 60 }, height: { xs: 40, sm: 60 }, zIndex: 1, ml: { xs: -1, sm: -2 } }}
                    />
                  </Box>
                </>
              )}
