                        ...
                        >
                            <Box sx={{ padding: 3 }}>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 2, }}>
                                    <FormControl variant="outlined" sx={{ m: 1, minWidth: '17em' }}>
                                        <InputLabel>Skill</InputLabel>
                                        <Select value={skill} onChange={e => setSkill(e.target.value)} label="Skill">
                                    ...
                                    <Button variant="contained" sx={{ m: 1 }}>Search</Button>
                                </Box>
                                {/* Course Cards */}
